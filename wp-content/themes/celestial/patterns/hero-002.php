...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:group {"layout":{"type":"constrained"}} -->
	<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|50"}},"layout":{"type":"constrained"}} -->
		<div class="wp-block-group"><!-- wp:heading {"level":1,"style":{"typography":{"textAlign":"center"}}} -->
			...
			<div class="wp-block-group"><!-- wp:paragraph {"style":{"typography":{"textAlign":"center"}}} -->
				<p class="has-text-align-center">Celestial combines a lightweight block theme, reusable patterns, design tokens, and a structured core plugin—giving you a clean starting point without locking the project into a heavy framework.</p>
				<!-- /wp:paragraph -->
	...
	<figure class="wp-block-image size-large is-resized"><img src="http://localhost:8888/wp-content/themes/celestial/assets/images/bg.jpg" alt="" style="aspect-ratio:1.7777777777777777;object-fit:cover;width:1200px;height:auto"/></figure>
	<!-- /wp:image --></div>
<!-- /wp:group -->
